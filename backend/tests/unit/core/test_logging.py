...
class TestSensitiveQueryFilter:
    ...
    def test_redacts_signed_queries_in_log_records(self, message):
    ...
    def test_redacts_exception_query_credentials(self):
        try:
    ...
    def test_preserves_uvicorn_access_formatter_arguments(self):
    ...
    def test_preserves_nonsensitive_mapping_log_arguments(self):
        record = logging.LogRecord(
            "app",
            logging.INFO,
            "",
